...
const Elephant = struct {
    ...
    // We had to make this an optional because the tail can either
    // point to another elephant or be null, in the first elephant example
    // Our elephant list a was circular, now that this is optional, the tail can point to
    // a null since optionals either have a value or are null. Error unions either have a value
    // or an error type.
    visited: bool = false,
};
